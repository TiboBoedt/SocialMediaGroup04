...
Sentiments2 <- apply(Sentiments2,2,as.character)

write.csv(Sentiments2, file ="/Users/xavierverbrugge/Documents/School/Master/Sem 2/Social Media and Web Analytics/Groupwork/Tweets_And_Labels_2.csv")
